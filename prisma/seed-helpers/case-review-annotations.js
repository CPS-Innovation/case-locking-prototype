...
// Evidence and issue annotations link to a real element about half the
...
function buildNoteAndLinks(snippet, elements) {
  if ((snippet.type === 'evidence' || snippet.type === 'issue') && elements.length && faker.datatype.boolean()) {
