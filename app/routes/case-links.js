...
// defendant name instead. Marcus Webb and Daniel Palmer are fixed named
// defendants belonging to Simon Whatley, so we sign straight in as Simon
// and redirect to the current case ID, skipping the "choose a user" screen.
