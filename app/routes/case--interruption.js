...
module.exports = router => {
  ...
  router.get('/interruption', async (req, res) => {
    ...
    const joinedByGroup = await joinSelectedTextByGroup(
      prisma,
      annotationLinks.map((link) => link.annotation),
    )
    const charges = buildOverviewCharges(
      _case.defendants,
      annotationLinks,
      submittedReview,
      joinedByGroup,
